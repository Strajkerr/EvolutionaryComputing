...
if __name__ == "__main__":
    ...
    path_m4_tspb = [
      25,104,56,8,111,82,87,21,36,141,97,77,81,153,106,124,62,18,55,34,143,35,109,0,29,144,160,33,49,11,138,182,139,43,168,195,126,13,145,15,3,70,161,132,169,65,188,6,150,192,147,85,134,2,74,118,98,51,120,67,71,191,90,133,122,135,131,121,112,19,151,198,24,1,197,16,38,27,42,156,30,117,193,31,54,164,73,173,136,105,190,80,46,162,175,78,142,45,5,177
    ]
    path_m4_tspb.append(path_m4_tspb[0])

    visualize_solution(nodesa, path_m1_tspa, costsa, title="M1 Steepest-Descent (2-node swap, random start) TSPA", save_path="M1_tspa.png")
    visualize_solution(nodesb, path_m1_tspb, costsb, title="M1 Steepest-Descent (2-node swap, random start) TSPB", save_path="M1_tspb.png")
    ...
    visualize_solution(nodesa, path_m3_tspa, costsa, title="M3 Steepest-Descent (2-opt, random start) TSPA", save_path="M3_tspa.png")
    visualize_solution(nodesb, path_m3_tspb, costsb, title="M3 Steepest-Descent (2-opt, random start) TSPB", save_path="M3_tspb.png")
